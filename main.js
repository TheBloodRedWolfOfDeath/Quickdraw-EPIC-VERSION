...
document.getElementById("sketch_to_be_drawn").innerHTML = "Please draw: " + Element_of_array + " in 15 seconds for a point!";
...
function updateCanvas() {
    ...
    sketch = element_of_array;
    document.getElementById("sketch_to_be_drawn").innerHTML = "Please draw: " + sketch + " in 15 seconds for a point!";
}
